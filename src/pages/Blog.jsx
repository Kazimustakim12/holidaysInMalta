...
const Blog = () => {
  ...
  console.log(posts, "all posts have been published");
  return (
    <>
      <Container className="" large>
        ...
        <div className="flex flex-col gap-7">
          {posts.slice(0, 1).map((post, index) => (
            <div
              key={index + post.id}
              className="w-full flex gap-5 md:flex-nowrap flex-wrap  bg-white items-center justify-center px-5 py-5 rounded-3xl"
            >
