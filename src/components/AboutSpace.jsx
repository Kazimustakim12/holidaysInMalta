...
const AboutSpace = ({ aboutDetail, loading }) => {
  return (
    <>
      {loading && (
      ...
      {aboutDetail && (
        ...
        "
          ...
          <div className="md:w-1/2 w-full">
            ...
            <p
              className="text-sm xl:text-base text-black font-light font-blinker xl:leading-[normal] leading-[normal]"
              dangerouslySetInnerHTML={{ __html: aboutDetail.text }}
            ></p>
          </div>
        </div>
      )}
...
AboutSpace.propTypes = {
  aboutDetail: PropsTypes.shape({
    text: PropsTypes.string,
    aboutImage: PropsTypes.string,
  }),
